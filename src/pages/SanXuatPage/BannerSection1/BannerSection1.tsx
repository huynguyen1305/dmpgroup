              ...
              <div className="w-1/2 h-full flex flex-col gap-2">
                ...
                <div className="mt-12 text-justify">
                  ...
                  <Typography className="text-xl font-light">
                    Cấu kiện bê tông dự ứng lức đúc sẵn do DPM sản xuất là các
                    sản phẩm xây dựng được sản xuất theo quy trình sản xuất và
                    quản lý chất lượng tại nhà máy cảu công ty DPM hoặc các đối
                    tác khác, đảm bảo về chất lượng, thẩm mỹ, đúng theo bản vẽ
                    thiết kế được khách hàng phê duyệt.
                  </Typography>

                  <Typography className="text-[4vh] font-extrabold capitalize mt-6">
                    Sản Xuất Các Cấu Kiện Bê Tông Cốt Thép Với Nhiều Ưu Điểm
                    Vượt Trội
                  </Typography>
                  <Typography className="text-xl font-light">
                    1. Bê tông chất lượng cao.
                  </Typography>
                  <Typography className="text-xl font-light">
                    2. Rút ngắn thời gian thi công.
                  </Typography>
                  <Typography className="text-xl font-light">
                    3. Tạo điều kiện xây dựng công nghiệp hoá.
                  </Typography>
                  <Typography className="text-xl font-light">
