    ...
    <div className="bg-[#70706E]">
      ...
      <div className="w-[60%] h-full mx-auto bg-[#70706E] px-12 pb-12">
        <div className="text-white text-xl text-justify">
          <p>
            Cấu kiện bê tông dự ứng lức đúc sẵn do DPM sản xuất là các sản phẩm
            xây dựng được sản xuất theo quy trình sản xuất và quản lý chất lượng
            tại nhà máy cảu công ty DPM hoặc các đối tác khác, đảm bảo về chất
            lượng, thẩm mỹ, đúng theo bản vẽ thiết kế được khách hàng phê duyệt.
          </p>
          <br />
          <p>Một số cấu kiện bê tông dự ứng lực đúc sẵn tại nhà máy DPM như:</p>

          <br />
          <img
            src="https://dpmgroup.123websitedev.com/wp-content/uploads/2023/09/Cot.jpg"
            className="w-full"
          />
          <p>Cột</p>
          <br />
          <img
            src="https://dpmgroup.123websitedev.com/wp-content/uploads/2023/09/dam.jpg"
            className="w-full"
          />
          <p>Dằm</p>
          <br />
          <img
            src="https://dpmgroup.123websitedev.com/wp-content/uploads/2023/09/san.jpg"
            className="w-full"
          />
          <p>Sàn ( dặc hoặc rỗng )</p>
          <br />
          <img
            src="https://dpmgroup.123websitedev.com/wp-content/uploads/2023/09/san-hllowcore.jpg"
            className="w-full"
          />
          <p>Sàn Hollowcore</p>
          <br />
          <div>
            <strong>Các nhà máy liên doanh</strong>
          </div>
          <br />
          <img
            src="https://dpmgroup.123websitedev.com/wp-content/uploads/2023/09/cac-nha-may-768x397.png"
            className="w-full"
          />
          <br />
        </div>
...
export default ActivePageSanXuat;
