            ...
            <div className="w-full h-full flex">
              <div className="w-1/2 h-full flex flex-col gap-2">
                ...
                <div className="mt-12 text-justify">
                  ...
                  <Typography className="text-xl font-light">
                    1. Lập biện pháp thi công được khách hàng phê duyệt.
                  </Typography>
                  <Typography className="text-xl font-light">
                    2. Chuẩn bị vật tư, thiết bị, máy móc, nhân công đáp ứng đặc
                    thù dự án theo biện pháp được phê duyệt.
                  </Typography>
                  <Typography className="text-xl font-light">
                    3. Nhận mặt bằng được bàn giao từ khách hàng, kiểm tra chéo
                    tim mực, ...
                  </Typography>
                  <Typography className="text-xl font-light">
                    4. Đặt hàng, nhận cấu kiện từ nhà máy.
                  </Typography>
                  <Typography className="text-xl font-light">
                    5. Thi công lắp đặt, cố định sản phẩm.
                  </Typography>
                  <Typography className="text-xl font-light">
                    6. Nghiệm thu bàn giao sản phẩm.
                  </Typography>
                  <br />
                  <Typography className="text-xl font-light">
                    Với các ưu điểm trên, DPM đã nhận được sự tin tưởng của các
                    khách hàng thi công các dự án như: LSP Long Hậu Giai đoạn 1
                    và 2, Logos Logiscstics Long Hậu, BW Tân Phú Trung, Paihong,
                    SLP Xuyên Á,...
                  </Typography>
                </div>
              </div>
