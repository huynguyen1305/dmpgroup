              ...
              <div className="w-1/2 h-full flex flex-col gap-2">
                ...
                <div className="mt-12 text-justify">
                  ...
                  <Typography className="text-xl font-light">
                    ...
                    Nhà xưởng, biệt thự liền kề,… sử dụng phương án bê tông dự
                    ứng lực đúc sẵn, DPM sẽ phối hợp tư vấn thiết kế phương án
                    tối ưu nhất về kết cấu, giá thành cũng như tiến độ thi công
