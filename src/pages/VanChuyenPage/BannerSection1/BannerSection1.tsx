...
const tableTmp = `
<table class="w-full text-white font-extralight"><tbody><tr><td>STT</td><td>XE CƠ GIỚI</td><td>SỐ LƯỢNG THIẾT BỊ</td><td>TẢI TRỌNG VẬN CHUYỂN</td><td>CẤU KIỆN VẬN CHUYỂN</td></tr><tr><td>1</td><td>XE ĐẦU KÉO SƠ MI RƠ MOOC</td><td>20</td><td>30 Tấn</td><td>&nbsp; Cột dài &lt; 14 m Dầm dài &lt; 14 m Sàn Cấu kiện khác: Sê nô, cầu thang,..</td></tr><tr><td>2</td><td>&nbsp;XE ĐẦU KÉO MOOC RÚT</td><td>10</td><td>30 tấn</td><td>&nbsp; Cột , dầm dài 14 25 m</td></tr><tr><td>3</td><td>&nbsp;XE ĐẦU KÉO Trailer</td><td>10</td><td>30 tấn</td><td>&nbsp; Cột , dầm dài &gt; 20 m</td></tr><tr><td>4</td><td>&nbsp;XE ĐẦU KÉO MOOC THẤP</td><td>10</td><td>40 tấn</td><td>&nbsp; XE CẨU BÁNH XÍCH</td></tr><tr><td>5</td><td>VẬN CHUYỂN BẰNG TÀU, XÀ LAN</td><td></td><td>lên đến 1000 tấn</td><td>&nbsp; Cột, dầm, sàn,.. Khi vận chuyển đên dự án ở đảo, khu vực cách xa nhà máy sản xuất &gt; 500 km</td></tr></tbody></table>
`;
            ...
            <div className="w-full h-full flex">
              <div className="w-1/2 h-full flex flex-col gap-2">
                ...
                <div className="mt-12 text-justify">
                  ...
                  <div dangerouslySetInnerHTML={{ __html: tableTmp }}></div>
                </div>
              </div>
              <div className="w-1/2 h-full p-10">
                <div className={`swiperContainer w-full h-full`}>
                  <Swiper
                    grabCursor
                    pagination={{
                      clickable: true,
